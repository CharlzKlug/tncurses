...
int DLLEXPORT Tncurses_Init(Tcl_Interp *interp) {
  ...
  Tcl_CreateObjCommand(interp, NS "::leaveok", LeaveOk_Cmd, NULL, NULL);
  Tcl_CreateObjCommand(interp, NS "::setscrreg", SetScrReg_Cmd, NULL, NULL);
  Tcl_CreateObjCommand(interp, NS "::wsetscrreg", WSetScrReg_Cmd, NULL, NULL);
  Tcl_CreateObjCommand(interp, NS "::nl", NL_Cmd, NULL, NULL);
  ...
  Tcl_CreateObjCommand(interp, NS "::keyname", KeyName_Cmd, NULL, NULL);
  Tcl_CreateObjCommand(interp, NS "::filter", Filter_Cmd, NULL, NULL);
  Tcl_CreateObjCommand(interp, NS "::nofilter", NoFilter_Cmd, NULL, NULL);
  ...
  Tcl_CreateObjCommand(interp, NS "::insch", InsCh_Cmd, NULL, NULL);
  ...
  Tcl_CreateObjCommand(interp, NS "::winsertln", WInsertLn_Cmd, NULL, NULL);
  Tcl_CreateObjCommand(interp, NS "::isendwin", IsEndWin_Cmd, NULL, NULL);
  /* Tcl_CreateObjCommand(interp, NS "::newterm", NewTerm_Cmd, NULL, NULL); */
  return TCL_OK;
}
