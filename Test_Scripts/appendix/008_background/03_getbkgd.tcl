...
tncurses::wbkgdset stdscr [expr [tncurses::COLOR_PAIR 1] | [scan "*" %c]]
tncurses::addstr "Hello, son, hello baby girl. My color_pair is '$color_pair'. Length is $color_pair_length. Chtype is [tncurses::getbkgd stdscr]."
tncurses::wbkgdset $sonny [tncurses::COLOR_PAIR 2]
tncurses::waddstr $sonny "Hello, Dad. Chtype is [tncurses::getbkgd $sonny]."
tncurses::wbkgd $babygirl [tncurses::COLOR_PAIR 3]
tncurses::waddstr $babygirl "Hello, Papa. Chtype is [tncurses::getbkgd $babygirl]."
tncurses::refresh
tncurses::getch
